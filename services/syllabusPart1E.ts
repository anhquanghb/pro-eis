...
/**
 * Service xuất đề cương chi tiết học phần (Phần 1 - Bản rút gọn E)
 */
export const syllabusPart1EService = {
          ...
          blockRows.push(new TableRow({
              children: [
                  new TableCell({
                      ...
                      children: [new Paragraph({ children: [new TextRun({ text: `${isChecked1} ${name1}`, size: 26 })] })]
                  }),
                  new TableCell({
                      width: { size: 58, type: WidthType.PERCENTAGE },
                      margins: { top: 60, bottom: 60, left: 100, right: 100 },
                      children: b2 ? [new Paragraph({ children: [new TextRun({ text: `${isChecked2} ${name2}`, size: 26 })] })] : []
                  })
              ]
          }));
      }
